<?php
    ...
    class ArmyController extends Controller
    {
        ...
        public function calculate_training_price(Request $request)
        {
            ...
            return ([$allowed, $food_required, $enough_food, $wood_required, $enough_wood, $rock_required, $enough_rock, $steel_required, $enough_steel, $gold_required, $enough_gold, $mount_required, $enough_mount, $duration, $items_owned, trans('unit.' . $unit->name)]);
        }
        ...
        public function train_unit(Request $request)
        {
            ...
            $user_race = DB::table('users')->where('user_id', '=', $user_id)->value('race');
            $unit_id = $request['unit_id'];
            $quantity = $request['quantity'];
            $unit = DB::table('units')
            ->where('id', '=', $unit_id)
