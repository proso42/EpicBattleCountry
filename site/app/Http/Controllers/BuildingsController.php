        ...
        public function index()
        {
            ...
            foreach ($all_eco_buildings as $val)
            {
                ...
                if ($niv >= 0)
                {
                    ...
                    $illustration = "images/" . $val->illustration;
                    $allowed_eco_buildings[] = ["name" => $val->name, "niv" => $niv, "illustration" => $illustration, "food_required" => $food_required, "wood_required" => $wood_required, "rock_required" => $rock_required, "steel_required" => $steel_required, "gold_required" => $gold_required];
                }
                else
                    continue;
            }
