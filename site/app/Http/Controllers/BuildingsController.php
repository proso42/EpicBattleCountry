<?php
    ...
    class BuildingsController extends Controller
    {
        public function index()
        {
            ...
            return view('buildings', compact('activeTab', 'food', 'compact_food', 'max_food', 'wood', 'compact_wood' ,'max_wood', 'rock', 'compact_rock', 'max_rock', 'steel', 'compact_steel', 'max_steel', 'gold', 'compact_gold', 'max_gold', 'allowed_eco_buildings', 'allowed_army_buildings', 'allowed_defensive_buildings', 'allowed_tech_buildings'));
        }
