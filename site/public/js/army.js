...
function timer(id, duration)
{
    ...
    else
    {
        ...
        compteur.textContent= trans('common.in_progress') + " : " + j + " " + h+" "+m+" "+s;
...
function train(id)
{
    ...
    xhr.onreadystatechange =  function()
    {
        if (xhr.readyState === 4 && xhr.status === 200)
        {
            ...
            document.getElementById("confirm-title").textContent = trans('army.train') + " " + quantity + " " + name + " ?";
            if (basic[1] > 0)
            {
                document.getElementById("food_list").textContent = trans('common.food') + " : " +  basic[1];
            ...
            if (basic[3] > 0)
            {
                document.getElementById("wood_list").textContent = trans('common.wood') + " : " +  basic[3];
            ...
            if (basic[5] > 0)
            {
                document.getElementById("rock_list").textContent = trans('common.rock') + " : " +  basic[5];
            ...
            if (basic[7] > 0)
            {
                document.getElementById("steel_list").textContent = trans('common.steel') + " : " +  basic[7];
            ...
            if (basic[9] > 0)
            {
                document.getElementById("gold_list").textContent = trans('common.gold') + " : " +  basic[9];
            ...
            {
                document.getElementById("mount_list").textContent = trans('army.mount') + " : " +  basic[11] + " x" + quantity;
                document.getElementById("mount_icon").className = basic[12];
                document.getElementById("list_last").style.display = "";
            }
            document.getElementById("time_list").textContent = trans('common.time') + " : " +  basic[13] + " ";
            var i = 0;
