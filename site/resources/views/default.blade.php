...
<div class="row" style="margin-left:0; margin-right: 0;">
    <div class="col-lg-2 col-md-2" style="margin-top: 50px;">
        ...
        <div onclick="document.location.href='/mercenaries'" class="row menu-left">
            <div class="col-lg-1 col-md-1 col-sm-1 col-1"><i class="fas fa-coins icon"></i></div>
            <div class="col-lg-3 col-md-3 col-sm-3 col-3">@lang('default.mercenaries')</div>
        </div>
        ...
        <div onclick="document.location.href='/quests'" class="row menu-left">
            <div class="col-lg-1 col-md-1 col-sm-1 col-1"><i class="fas fa-book icon"></i></div>
            <div class="col-lg-3 col-md-3 col-sm-3 col-3">@lang('default.quests')</div>
        </div>
