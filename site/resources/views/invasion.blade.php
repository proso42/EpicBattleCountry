                ...
                <div id="list_unit" style="display: none; text-align: center;margin-top: 25px;">
                        @foreach ($info_unit as $unit)
                            <div id="unit_{{ $unit['ref'] }}" class="row invasion-unit-line" unit_ref="{{ $unit['ref'] }}">
                                ...
                                <span class="col-lg-1 col-md-1 col-sm-1 col-1"><i onmousedown="add_unit('{{ $unit['ref'] }}', '{{ $unit['quantity'] }}')" class="fas fa-plus invasion-plus"></i></span>
                                <span class="col-lg-1 col-md-1 col-sm-1 col-1"><i onmousedown="remove_unit('{{ $unit['ref'] }}', '{{ $unit['quantity'] }}')" class="fas fa-minus invasion-minus"></i></span>
                            </div>
                        @endforeach
