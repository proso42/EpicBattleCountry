            ...
            <div class="col-lg-9 col-md-4 center-win">
                ...
                <div>
                    <div class="row" style="align-items: baseline;">
                        <span class="col-lg-3 offset-lg-2" id="current_login" name="current_login" style="margin-right: 20px;">Psuedo : {{ $user_login }}</span><input id="new_login" name="new_login" class="settings-input col-lg-2" placeholder="Nouveau pseudo" type="text" pattern="[a-zA-Z]{3,20}"><input id="_token" name="_token" type="hidden" value="{{ csrf_token() }}"> <img id="spin_login" class="settings-spin col-lg-2" style="display: none" src="images/loader.gif"><input onclick="reset_login()" id="change_login_button" class="settings-button col-lg-2" type="button" value="Modifier">
                    </div>
                    <div class="row" style="align-items: baseline;">
                        <span class="col-lg-3 offset-lg-2" id="current_email" name="current_email" style="margin-right: 20px;">Email : {{ $user_email }}</span><input id="new_email" name="new_email" class="settings-input col-lg-2" placeholder="Nouvel email" type="text"><input id="_token2" name="_token2" type="hidden" value="{{ csrf_token() }}"><div style="margin-top: 15px;"><img id="spin_email" class="settings-spin col-lg-2" style="display: none" src="images/loader.gif"></div><input onclick="reset_email()" id="change_email_button" class="settings-button col-lg-2" type="button" value="Modifier">
                    </div>
                </div>
            </div>
        </div>
