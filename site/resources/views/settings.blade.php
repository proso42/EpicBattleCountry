            ...
            <div class="col-lg-9 col-md-8 center-win">
                ...
                <div>
                    ...
                    <div class="row large-screen" style="align-items: baseline;line-height: 31px;">
                        <span class="col-lg-4 col-md-5" id="current_email-lg" name="current_email" alt="{{ $complete_enail }}">Email : {{ $user_email }}</span>
                    ...
                    <div class="medium-screen" style="align-items: baseline;line-height: 31px;">
                        <span id="current-email-md" name="current_email" alt="{{ $complete_enail }}">Email : {{ $user_email }}</span>
                        <br class="md-br"/>
                    ...
                    <div class="small-screen" style="align-items: baseline;line-height: 31px;">
                        <span id="current-email-sm" name="current_email" alt="{{ $complete_enail }}">Email : {{ $user_email }}</span>
                        <br/>
